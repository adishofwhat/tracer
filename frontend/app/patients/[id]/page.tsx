          ...
          <div className="bg-white border border-gray-200 rounded-lg">
            <div className="p-4 border-b border-gray-100">
              ...
              <p className="text-xs text-gray-500 mt-0.5">
                {p.clinical_note.provider} · {p.clinical_note.specialty ?? "General"} · {p.clinical_note.date}
              </p>
            </div>
            <div className="p-4">
              <div className="max-h-96 overflow-y-auto text-sm text-gray-700 whitespace-pre-wrap leading-7 p-4 bg-gray-50 rounded font-sans">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6 items-start">
          ...
          <div className="bg-white border border-gray-200 rounded-lg">
            ...
            {p.results.map((r, i) => (
              <div
                key={r.result_id}
                className={`p-4 ${i < p.results.length - 1 ? "border-b border-gray-100" : ""}`}
              >
